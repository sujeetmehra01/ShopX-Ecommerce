...
urlpatterns = [
    # path('', views.home), # function based urls
    path('', views.ProductView.as_view(), name="home"),  # class based urls
    path('product-detail/<int:pk>',
         views.ProductDetailView.as_view(), name='product-detail'),  # class based urls
...
] + static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)  # dynamic images configurations
